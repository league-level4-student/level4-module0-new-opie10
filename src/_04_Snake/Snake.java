...
public class Snake {
	...
	public boolean isOutOfBounds() {
		if (head.getLocation().getX()<0||head.getLocation().getY()<0||head.getLocation().getX()>SnakeGame.WIDTH||head.getLocation().getY()>SnakeGame.HEIGHT) {
			return true;
		}
		/*
	...
	public boolean isHeadCollidingWithBody() {
		for (int i = 1; i < snake.size(); i++) {
			if (head.getLocation().locationEquals(snake.get(i).getLocation().getX(),snake.get(i).getLocation().getY() )) {
				return true;
			}
		}
		/*
	...
	public boolean isLocationOnSnake(Location loc) {
		for (int i = 0; i <snake.size(); i++) {
			if (loc.locationEquals(snake.get(i).getLocation().getX(),snake.get(i).getLocation().getY())) {
				return true;
			}
		}
		/*
